        ...
        <div class="admin-tabs-container sticky top-0 z-50 shadow-sm">
            <div class="container max-w-6xl px-6">
                <nav class="flex gap-2">
                    <a routerLink="/admin/dashboard" routerLinkActive="active" class="admin-tab-link">
                        <span class="material-icons-outlined text-sm">dashboard</span>
                        <span>Dashboard</span>
                    </a>
                    <a routerLink="/admin/orders" routerLinkActive="active" class="admin-tab-link">
                        <span class="material-icons-outlined text-sm">receipt_long</span>
                        <span>Orders</span>
                    </a>
                    <a routerLink="/admin/drivers" routerLinkActive="active" class="admin-tab-link">
                        <span class="material-icons-outlined text-sm">people</span>
                        <span>Manage Partners</span>
                    </a>
                    <a routerLink="/admin/vehicles" routerLinkActive="active" class="admin-tab-link">
                        <span class="material-icons-outlined text-sm">local_shipping</span>
                        <span>Manage Fleet</span>
                    </a>
                    <a routerLink="/admin/pricing" routerLinkActive="active" class="admin-tab-link">
